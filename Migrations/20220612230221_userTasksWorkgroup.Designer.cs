...
namespace Diplom.Auth.Migrations
{
    ...
    [Migration("20220612230221_userTasksWorkgroup")]
    partial class userTasksWorkgroup
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Diplom.Auth.Models.MessageReferences", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Diplom.Models.Message", b =>
                {
                    ...
                    b.Property<int?>("messageCreatorId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Diplom.Auth.Models.File", b =>
                {
                    ...
                    b.HasOne("Diplom.Models.Message", null)
                        .WithMany("Files")
            ...
            modelBuilder.Entity("Diplom.Models.Message", b =>
                {
                    ...
                    b.HasOne("Diplom.Models.Account", "messageCreator")
                        .WithMany()
                        .HasForeignKey("messageCreatorId");
            ...
            modelBuilder.Entity("Diplom.Models.UserTask", b =>
                {
                    ...
                    b.HasOne("Diplom.Auth.Models.WorkgroupTask", null)
                        .WithMany("UserTasks")
